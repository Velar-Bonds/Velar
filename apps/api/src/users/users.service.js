...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.updateProfile = function (userId, updates) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error;
        ...
        UsersService_1.prototype.listUsers = function (actorRole) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_1.prototype.setRole = function (targetId, role, actorRole) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (actorRole !== 'admin')
                                throw new common_1.ForbiddenException('Admin only');
                            return [4 /*yield*/, this.supabase.admin
                                    .from('profiles').update({ role: role }).eq('id', targetId).select().single()];
                        case 1:
                            _a = _b.sent(), data = _a.data, error = _a.error;
                            if (error)
                                throw new common_1.BadRequestException(error.message);
