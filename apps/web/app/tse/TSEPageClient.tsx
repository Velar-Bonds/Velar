...
import { SEED_BONDS, SEED_REQUESTS, SEED_TRANSFERS } from '../../lib/tse-seed';
...
export default function TSEPageClient() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setRequests(Array.isArray(rqs) && rqs.length ? rqs : SEED_REQUESTS);
      setTransfers(Array.isArray(trs) && trs.length ? trs : SEED_TRANSFERS);
    });
