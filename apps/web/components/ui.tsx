...
export function StellarExpertButton({
  href,
...
const STATUS: Record<string, { cls: string; label: string }> = {
  ...
  en_venta: { cls: 'bg-blue-50 text-primary border-blue-200', label: 'En venta' },
  ...
  transferido: { cls: 'bg-slate-100 text-slate-700 border-slate-200', label: 'Transferido' },
  ...
  contraoferta: { cls: 'bg-sky-50 text-primary border-blue-200', label: 'Contraoferta' },
  pago_registrado: { cls: 'bg-blue-50 text-primary border-blue-200', label: 'Pago registrado' },
...
export function EmptyState({
  ...
  return (
    <div className="velar-empty flex flex-col items-center justify-center px-6 py-16 text-center">
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-container/10 text-primary-container">
        {icon}
      </div>
...
export const fmtMoney = (n: number | null | undefined) =>
  n == null ? 'Sin monto' : '$' + Number(n).toLocaleString('es-CR');
